...
Initial configuration: the desired temprature value in the controller sets to the value 21 and the window is close so that the outside cold air does not blow inside. The temprature is increased in the room. 
