...
The initial configuration of the system: the desired temprature value in the controller sets to the value 21. The window in the room is close so that the outside cold air does not blow inside. The temprature is increased in the room. 
